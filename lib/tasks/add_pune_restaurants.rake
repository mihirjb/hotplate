...
@restaurant = Restaurant.create(:restname => rname, :rtimings => rtimings, :rcost => rcost, :raddress => raddress, :city => "Pune", :delivers => 0 , :rarea => rarea,:rcuisine => rcuisine,:rfeatures => rfeatures)
